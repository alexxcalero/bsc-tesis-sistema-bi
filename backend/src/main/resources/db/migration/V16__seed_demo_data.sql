-- ============================================================
-- V16: Seed de datos demo pequeños (historia)
-- Limpia data anterior de V8 e inserta datos demo pequeños.
-- Los CSVs grandes se cargan vía Módulo 2 para el video.
-- ============================================================

-- -----------------------------------------------------------------
-- 1. LIMPIAR DATA DEMO ANTERIOR (V8)
-- -----------------------------------------------------------------
DELETE FROM ofertas;
...
-- -----------------------------------------------------------------
-- 2. AGREGAR PERIODOS FALTANTES (2025-04 a 2026-07)
-- -----------------------------------------------------------------
INSERT INTO periodos (codigo, nombre, descripcion) VALUES
('2025-04', 'Abril 2025', 'Abril 2025'),
('2025-05', 'Mayo 2025', 'Mayo 2025'),
('2025-06', 'Junio 2025', 'Junio 2025'),
('2025-07', 'Julio 2025', 'Julio 2025'),
('2025-08', 'Agosto 2025', 'Agosto 2025'),
('2025-09', 'Setiembre 2025', 'Setiembre 2025'),
('2025-10', 'Octubre 2025', 'Octubre 2025'),
('2025-11', 'Noviembre 2025', 'Noviembre 2025'),
('2025-12', 'Diciembre 2025', 'Diciembre 2025'),
('2026-01', 'Enero 2026', 'Enero 2026'),
('2026-02', 'Febrero 2026', 'Febrero 2026'),
('2026-03', 'Marzo 2026', 'Marzo 2026'),
('2026-04', 'Abril 2026', 'Abril 2026'),
('2026-05', 'Mayo 2026', 'Mayo 2026'),
('2026-06', 'Junio 2026', 'Junio 2026'),
('2026-07', 'Julio 2026', 'Julio 2026');
