...
public class DashboardController {
    ...
    public ResponseEntity<DashboardResponse> resumen(@ModelAttribute DashboardFiltroRequest filtros) {
        return ResponseEntity.ok(dashboardService.obtenerDashboard(filtros));
    }
}
